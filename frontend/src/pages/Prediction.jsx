  ...
  return (
    <div className="page-container">
      ...
      <div style={{ display: "flex", gap: "1rem", marginBottom: "1.5rem" }}>
        ...
        >
          <Zap size={16} />
          <span>Regional Outage Predictor</span>
        </button>
        <button
        ...
        >
          <Cpu size={16} />
          <span>Equipment Failure Diagnostics</span>
        </button>
      </div>
        ...
        <div className="dashboard-grid-main">
          <div className="glass-panel">
            <div className="panel-header">
              ...
              <span className="panel-subtitle">Weather & Load Simulation</span>
            </div>
            ...
            <form onSubmit={handlePredictOutage}>
              ...
              <button type="submit" className="btn-primary" style={{ width: "100%", marginTop: "0.5rem" }} disabled={loadingOutage}>
                <Zap size={16} />
                <span>{loadingOutage ? "Calculating..." : "Compute Outage Risk"}</span>
              </button>
            </form>
          </div>
            ...
            <div className={`prediction-result-panel ${outageResult ? "has-data" : ""}`}>
              {outageResult ? (
                ...
                <div className="empty-state">
                  ...
                  <span className="empty-desc">Input meteorological and grid parameters and run the assessment to view explainable risk breakdowns.</span>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="dashboard-grid-main">
          <div className="glass-panel">
            <div className="panel-header">
              ...
              <span className="panel-subtitle">IEEE/CIGRE Asset Diagnostic</span>
            </div>
            ...
            <form onSubmit={handlePredictEquipment}>
              ...
              <button type="submit" className="btn-primary" style={{ width: "100%", marginTop: "0.5rem" }} disabled={loadingEq}>
                <Cpu size={16} />
                <span>{loadingEq ? "Diagnosing..." : "Run Asset Diagnostics"}</span>
              </button>
            </form>
          </div>
                ...
                <div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", margin: "1rem 0" }}>
                    <div style={{ background: "rgba(0,0,0,0.3)", padding: "0.85rem", borderRadius: "var(--radius-sm)" }}>
                      ...
                      <div style={{ fontSize: "1.5rem", fontWeight: 800, color: (eqResult.failure_risk || 0) >= 70 ? "var(--red)" : "var(--amber)" }}>
